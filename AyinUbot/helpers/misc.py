...
def git():
    ...
    try:
        repo = Repo()
        LOGGER("AyinUbot").info(f"Git Client Found")
    except GitCommandError:
        LOGGER("AyinUbot").info(f"Invalid Git Command")
        ...
        LOGGER("AyinUbot").info("Fetched Latest Updates")
    ...
    if is_heroku:
        if HEROKU_API_KEY and HEROKU_APP_NAME:
            try:
                ...
                LOGGER("AyinUbot").info(f"Heroku App Configured")
