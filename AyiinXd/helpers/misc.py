...
def git():
    ...
    try:
        repo = Repo()
        LOGGER("AyiinXd").info(f"Git Client Found")
    except GitCommandError:
        LOGGER("AyiinXd").info(f"Invalid Git Command")
        ...
        LOGGER("AyiinXd").info("Fetched Latest Updates")
    ...
    if is_heroku:
        if HEROKU_API_KEY and HEROKU_APP_NAME:
            try:
                ...
                LOGGER("AyiinXd").info(f"Heroku App Configured")
